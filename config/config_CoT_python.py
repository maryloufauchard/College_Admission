...
path = {
    ...
    'output_path': '/home/mila/m/marylou.fauchard/llm_scp/Generation_CoT_python_Llama70B', # CHANGE FOR EACH MODEL !!
    'instance_dir' : '/home/mila/m/marylou.fauchard/llm_scp/LLM_instances_v2', 
    'instruction_dir' : '/home/mila/m/marylou.fauchard/llm_scp/LLM_instruction_CoT_python',
